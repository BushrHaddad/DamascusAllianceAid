...
<form method="post" action="FamilyEditor.php?FamilyID=<?php echo $iFamilyID ?>" id="familyEditor">
    ...
    ?><span style="color: red;"><?= $sNameError ?></span><?php
                ...
                <div class="row">
                    <div id="stateOptionDiv" class="form-group col-md-3">
                        ...
                        <select id="State" name="State" class="form-control select2" id="state-input"
                            data-user-selected="<?= $sState ?>"
                    ...
                    <div id="stateInputDiv" class="form-group col-md-3 hidden">
                        ...
                        <input id="StateTextbox" type="text" class="form-control" name="StateTextbox"
                            value="<?= htmlentities(stripslashes($sState), ENT_NOQUOTES, 'UTF-8') ?>" size="20"
                            maxlength="30">
                    </div>
                    <div class="form-group col-md-3">
                        <label> <?= gettext('Country') ?>:</label>
                        <select id="Country" name="Country" class="form-control select2" id="country-input"
                            data-user-selected="<?= $sCountry ?>"
                            data-system-default="<?= SystemConfig::getValue('sDefaultCountry')?>">
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="CellPhone" value="<?= $sCellPhone ?>" size="30" maxlength="30"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" Name="Email" class="form-control" value="<?= $sEmail ?>" size="30"
                            maxlength="100"><span style="color: red;"><?php echo '<BR>'.$sEmailError ?></span>
                    </div>
                </div>
            </div>
    ...
    <div class="box box-info clearfix">
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="MediumText">
                                <center>
                                    <?= $iFamilyID < 0 ? gettext('You may create family members now or add them later.  All entries will become <i>new</i> person records.') : '' ?>
                                </center>
                            </div><br><br>
        ...
        for ($iCount = 1; $iCount <= $iFamilyMemberRows; $iCount++) {
            ?>
                                    <input type="hidden" name="PersonID<?= $iCount ?>"
                                        value="<?= $aPersonIDs[$iCount] ?>">
                                    <tr>
                                        <td class="TextColumn">
                                            <input name="FirstName<?= $iCount ?>" type="text"
                ...
                echo $aFirstNameError[$iCount];
                                        ...
                                        <td class="TextColumn">
                                            <input name="MiddleName<?= $iCount ?>" type="text"
                                                value="<?= $aMiddleNames[$iCount] ?>" size="10">
                                        </td>
                                        <td class="TextColumn">
                                            <input name="LastName<?= $iCount ?>" type="text"
                                                value="<?= $aLastNames[$iCount] ?>" size="10">
                                        </td>
                                        <td class="TextColumn">
                                            <input name="Suffix<?= $iCount ?>" type="text"
                ...
                for ($c = 1; $c <= $numFamilyRoles; $c++) {
                    ...
                    $UpdateBirthYear = 1; ?>
                                            <input name="BirthYear<?= $iCount ?>" type="text"
                                                value="<?= $aBirthYears[$iCount] ?>" size="4" maxlength="4">
...
?>
                                                <script src="<?= SystemURLs::getRootPath() ?>/skin/js/FamilyEditor.js">
                                                </script>
